...
export default function ProfileEditModal({open, onClose, initialData}: Props) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 backdrop-blur-sm">
            <div className="relative w-[800px] bg-[#1e1f22] rounded-xl overflow-hidden border border-gray-700 shadow-lg">
                <div className="bg-blue-800 h-36 relative">
                    <button onClick={onClose} className="absolute top-4 right-4 text-white text-2xl hover:opacity-80">
                        ×
                    </button>
                ...
                <div className="pt-16 px-8 pb-8 text-white">
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            <h2 className="text-2xl font-bold">{userName || "프로필 이름"}</h2>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <label className="text-sm text-gray-400">상태 메시지 (status_name)</label>
                            <input
                                type="text"
                                value={statusName}
                        ...
                        <div>
                            <label className="text-sm text-gray-400">한 줄 소개 (information)</label>
                            <textarea
                                value={information}
