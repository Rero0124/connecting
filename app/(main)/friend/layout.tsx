        ...
        <>
            ...
            >
                ...
                >
                    <Menu
                        name="list"
                        classname={selectedFriendMenu === "list" ? "bg-background-light" : "hover:bg-background-light"}
                    >
                        친구목록
                    </Menu>
                    <Menu
                        name="add"
                        classname={selectedFriendMenu === "add" ? "bg-background-light" : "hover:bg-background-light"}
                    >
                        친구추가
                    </Menu>
                    <Menu
                        name="manage"
                        classname={
                            selectedFriendMenu === "manage" ? "bg-background-light" : "hover:bg-background-light"
                        }
                    >
                        친구 관리
                    </Menu>
